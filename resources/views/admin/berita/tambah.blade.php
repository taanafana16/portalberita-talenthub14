...
@section('content')
    ...
    <div class="page-heading p-6">
        <div class="page-title">
            <h3 class="text-2xl font-semibold font-semibold text-color4">Tambah Data Berita</h3>
        </div>
        ...
        <nav aria-label="breadcrumb" class="mt-4 flex justify-end"">
            <ol class="breadcrumb flex text-sm">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('admin.berita.index') }}" class="text-color6 hover:underline">Data Berita</a>
                </li>
                <li class="breadcrumb-item active text-color4 font-semibold" aria-current="page">Tambah Data Berita</li>
            </ol>
        </nav>
        <!-- ======= End Breadcrumb ======= -->
    </div>
    ...
    <section class="section pl-6 pr-6">
        ...
        <div class="card bg-white shadow-md rounded-lg p-2">
            ...
            <div class="card-header px-4 py-2 border-b">
                <h4 class="text-lg text-color4 font-semibold">Tambah Data Berita</h4>
            </div>
            <!-- ======= End Card Header ======= -->
            ...
            <div class="card-body">
                <div class="container mx-auto p-4">
                    ...
                    <form class="bg-white rounded-lg" action="{{ route('admin.berita.store') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="flex mt-1">
                                    ...
                                    <input type="text" id="kolomjudulberita"
                                        class="placeholder-green block w-full inline-flex px-3 border  border-color1 rounded-none rounded-r-md text-color focus:ring-color3 focus:border-color3"
                            ...
                            <div class="form-group">
                                ...
                                <div class="flex mt-1">
                                    ...
                                    <input type="text" id="captionfoto1"
                                        ...
                                        placeholder="Masukkan Keterangan Gambar" name="captionfoto1">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="flex mt-1">
                                    ...
                                    <input type="text" id="captionfoto2"
                                        class="placeholder-green block w-full inline-flex px-3 border  border-color1 rounded-none rounded-r-md text-color3 focus:ring-color3 focus:border-color3"
                                        placeholder="Masukkan Keterangan Gambar" name="captionfoto2">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="flex mt-1">
                                    ...
                                    <input type="text" id="captionfoto3"
                                        class="placeholder-green block w-full inline-flex px-3 border  border-color1 rounded-none rounded-r-md text-color3 focus:ring-color3 focus:border-color3"
                                        placeholder="Masukkan Keterangan Gambar" name="captionfoto3">
                                </div>
                            </div>
