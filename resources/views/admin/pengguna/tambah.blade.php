...
@section('content')
    ...
    <div class="page-heading p-6">
        <div class="page-title">
            <h3 class="text-2xl font-semibold text-color4">Tambah Data Pengguna</h3>
        </div>
        ...
        <nav aria-label="breadcrumb" class="mt-4 flex justify-end">
            <ol class="breadcrumb flex text-sm">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('admin.user.index') }}" class="text-color6 hover:underline">Data Pengguna</a>
                </li>
                <li class="breadcrumb-item active text-color4 font-semibold" aria-current="page">Tambah Data Pengguna</li>
            </ol>
        </nav>
        <!-- ======= End Breadcrumb ======= -->
    </div>
    ...
    <section class="section pl-6 pr-6">
        ...
        <div class="card bg-white shadow-md rounded-lg p-2">
            ...
            <div class="card-header px-4 py-2 border-b">
                <h4 class="text-lg font-semibold text-color4">Tambah Data Pengguna</h4>
            </div>
            <div class="container mx-auto p-4">
                <!-- ======= Form Tambah Data Pengguna ======= -->
                <form class="bg-white rounded-lg" action="{{ route('admin.user.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="flex mt-1">
                                ...
                                <input type="text" id="nohp"
                                    class="placeholder-green block w-full inline-flex px-3 border  border-color1 rounded-none rounded-r-md text-color3 focus:ring-color3 focus:border-color3"
                                    placeholder="Masukkan No Handphone" name="nohp">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="flex mt-1">
                                ...
                                <textarea id="alamat"
                                    ...
                                    placeholder="Masukkan Alamat" name="alamat" rows="3"></textarea>
                            </div>
                        </div>
                            ...
                            <div class="flex mt-1">
                                ...
                                <select id="role_id"
                                    ...
                                    @foreach ($role as $levelakses)
                                        <option value="{{ $levelakses->id }}">{{ $levelakses->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
