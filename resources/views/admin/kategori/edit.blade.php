...
@section('content')
    ...
    <div class="page-heading p-6">
        <div class="page-title">
            <h3 class="text-2xl font-semibold text-color4">Edit Kategori Berita</h3>
        </div>
        ...
        <nav aria-label="breadcrumb" class="mt-4 flex justify-end">
            <ol class="breadcrumb flex text-sm">
                ...
                <li class="breadcrumb-item active text-color4 font-semibold" aria-current="page">Edit Kategori Berita</li>
            </ol>
        </nav>
        <!-- ======= End Breadcrumb ======= -->
    </div>
    ...
    <section class="section pl-6 pr-6">
        ...
        <div class="card bg-white shadow-md rounded-lg p-2">
            ...
            <div class="card-header px-4 py-2 border-b">
                <h4 class="text-lg font-semibold text-color4">Edit Kategori Berita</h4>
            </div>

            <div class="container mx-auto p-4">
                <!-- ======= Form Edit Data Berita ======= -->
                <form <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <div class="form-group">
                            <label for="nama" class="block text-color4">Nama Kategori Berita</label>
                            <div class="flex mt-1">
                                <span
                        ...
                        <div class="form-group">
                            ...
                            <div class="flex mt-1">
                                ...
                                <textarea id="deskripsi"
                                    ...
                                    name="deskripsi" rows="3" value="#">{{ $kategori->deskripsi }}</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- ======= End Grid Container ======= -->
