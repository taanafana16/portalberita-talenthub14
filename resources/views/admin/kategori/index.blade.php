...
@section('content')
    ...
    <div class="page-heading p-6">
        <div class="page-title">
            <h3 class="text-2xl font-semibold text-color4">Data Kategori Berita</h3>
        </div>
        ...
        <nav aria-label="breadcrumb" class="mt-4 flex justify-end">
            <ol class="breadcrumb flex text-sm">
                ...
                <li class="breadcrumb-item active text-color4 font-semibold" aria-current="page">Data Kategori Berita</li>
            </ol>
        </nav>
        <!-- ======= End Breadcrumb ======= -->
    </div>
    ...
    <section class="section pl-6 pr-6">
        ...
        <div class="card bg-white shadow-md rounded-lg p-2">
            ...
            <div class="card-header px-4 py-2 border-b">
                <h4 class="text-lg text-color4 font-semibold">Data Kategori Berita</h4>
            </div>
            <!-- ======= End Card Header ======= -->
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-color7 border-b">
                        <thead class="text-xs text-color7 font-bold uppercase bg-color6">
                            <tr align="center">
                                ...
                                <th scope="col" class="px-6 py-3">Nama Kategori Berita</th>
                                <th scope="col" class="px-6 py-3">Deskripsi Kategori</th>
                        ...
                        <tbody align="center">
                            ...
                            @foreach ($kategori as $kelompok)
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-4">{{ $kelompok->nama }}</td>
                                    <td class="px-6 py-4">{{ $kelompok->deskripsi }}</td>
                                    <td class="px-6 py-4">
                                        <!-- ======= Button ======= -->
                                        <div class="buttons space-x-2">
                                            <form action="{{ route('admin.kategori.destroy', $kelompok->id) }}"
                                                method="POST" id="delete-form">
                                                @csrf
                                                @method('DELETE')

                                                <div class="flex space-x-2 flex justify-center">
                                                    <a href="{{ route('admin.kategori.show', $kelompok->id) }}"
                                                    ...
                                                    <a href="{{ route('admin.kategori.edit', $kelompok->id) }}"
